# Welcome to the Learn Cloud Assembly Contributing Guide

Thank you for your interest in contributing to Learn Cloud Assembly. In this guide you will learn how to contribute to the project.
...
# Create a new issue
The first way to request changes to the project is to create an issue. If you spot a problem with the docs, search if an issue already exists. If a related issue doesn't exist, you can open a new issue using the [GitHub issue tracker](https://github.com/cmbu-tmm-sites/learncloudassembly/issues).
